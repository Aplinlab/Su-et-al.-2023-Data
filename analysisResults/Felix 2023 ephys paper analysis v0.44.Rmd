...
evoked_data <- subset(iDC_comparison, iDC_comparison$idc_amp != 500)
...
iDC_block <- subset(iDC_block, iDC_block$t_test > 0.05)
...
kruskal.test(recovery_time ~ stim_type, data = iDC_recovery)
pairwise.wilcox.test(iDC_recovery$recovery_time, iDC_recovery$stim_type,
                 p.adjust.method = "BH")
